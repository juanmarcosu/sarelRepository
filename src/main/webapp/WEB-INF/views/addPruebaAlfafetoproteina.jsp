...
<head>
	...
	<title>Prueba de Alfafetoproteina</title>
...
<body class="ng-cloak" onload="checkMod()">
	...
	<div class="panel-heading"><span class="lead">Prueba de Alfafetoproteina </span></div>
     	<div class="formcontainer">
     	<div class="tablecontainer">
	<form:form modelAttribute="pruebaAlfafetoproteina" method="POST" class="form-horizontal"  >
	...
	<div id = "wholeForm">
		...
		<table>
			...
			<tr>
				...
				<td><label for="lresultado"> ng/mL &nbsp; &nbsp; &nbsp;</label> </td> 
				<td><div class="has-error"><form:errors path="resultado" class="help-inline"/></div></td>
				<td><label>Menor de 10.9 ng/mL </label> </td>
			</tr> 
		    <tr>
