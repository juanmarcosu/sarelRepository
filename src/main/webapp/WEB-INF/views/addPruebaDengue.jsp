...
<body class="ng-cloak" onload="checkMod()">
	...
	<div class="panel-heading"><span class="lead">Prueba de Dengue</span></div>
     	<div class="formcontainer">
     	<div class="tablecontainer">
	<form:form modelAttribute="pruebaDengue" method="POST" class="form-horizontal"  >
