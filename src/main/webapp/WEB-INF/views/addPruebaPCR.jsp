...
<body class="ng-cloak" onload="checkMod()">
	...
	<div class="panel-heading"><span class="lead">Prueba PCR </span></div>
     	<div class="formcontainer">
     	<div class="tablecontainer">
	<form:form modelAttribute="pruebaPCR" method="POST" class="form-horizontal"  >
	...
	<div id = "wholeForm">
		...
		<table>
		    ...
		    <tr>
				...
				<td><label for="lresultado"> mg/L &nbsp; &nbsp; &nbsp;</label> </td> 
				<td><div class="has-error"><form:errors path="resultado" class="help-inline"/></div></td>
				<td><label>Bajo Riesgo:   Menor de 1 .0 mg/L </label> </td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
				<td><label>Riesgo Medio:   1.0 -  3.0 mg/L </label> </td> 
		    </tr>
		    <tr>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
				<td><label>Riesgo Alto:   Mayor de 3.0 mg/L</label> </td> 
		    </tr>
		    <tr>
