...
public class GlucosaPreYPost {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof GlucosaPreYPost))
			return false;
		GlucosaPreYPost other = (GlucosaPreYPost) obj;
		if (id != other.id)
			return false;
	...
	public BigDecimal getPrePrandial() {
		return prePrandial;
	}
	public void setPrePrandial(BigDecimal prePrandial) {
		this.prePrandial = prePrandial;
	}
	public BigDecimal getPostPrandial() {
		return postPrandial;
	}
	public void setPostPrandial(BigDecimal postPrandial) {
	...
	public String toString() {
		return "GlucosaPreYPost [id ="+ id +", idExpediente=" + idExpediente 
				+", prePrandial=" + prePrandial +", postPrandial=" + postPrandial +", idQuimicoBiologo=" + idQuimicoBiologo
