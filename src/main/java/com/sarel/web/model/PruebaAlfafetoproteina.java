...
@Entity
@Table(name="PRUEBA_ALFAFETOPROTEINA")
public class PruebaAlfafetoproteina {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof PruebaAlfafetoproteina))
			return false;
		PruebaAlfafetoproteina other = (PruebaAlfafetoproteina) obj;
		if (id != other.id)
			return false;
	...
	public String toString() {
		return "PruebaAlfafetoproteina [id ="+ id +", idExpediente=" + idExpediente 
