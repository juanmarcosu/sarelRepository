...
@Entity
@Table(name="ACIDO_URICO", schema="laboratorio")
public class AcidoUrico {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof AcidoUrico))
			return false;
		AcidoUrico other = (AcidoUrico) obj;
		if (id != other.id)
			return false;
	...
	public BigDecimal getNivelAcidoUrico() {
		return nivelAcidoUrico;
	}
	public void setNivelAcidoUrico(BigDecimal nivelAcidoUrico) {
		this.nivelAcidoUrico = nivelAcidoUrico;
	}
	...
	public String toString() {
		return "AcidoUrico [id ="+ id +", idExpediente=" + idExpediente 
				+", nivelAcidoUrico=" + nivelAcidoUrico +", idQuimicoBiologo=" + idQuimicoBiologo
