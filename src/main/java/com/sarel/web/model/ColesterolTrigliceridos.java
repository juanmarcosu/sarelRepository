...
public class ColesterolTrigliceridos {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof ColesterolTrigliceridos))
			return false;
		ColesterolTrigliceridos other = (ColesterolTrigliceridos) obj;
		if (id != other.id)
			return false;
	...
	public String toString() {
		return "Colesterol-Trigliceridos [id ="+ id +", idExpediente=" + idExpediente 
				+", colesterol=" + colesterol +", trigliceridos=" + trigliceridos + ", idQuimicoBiologo=" + idQuimicoBiologo
