...
@Entity
@Table(name="HELICOBACTER_PYLORI", schema="laboratorio")
public class HelicobacterPylori {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof HelicobacterPylori))
			return false;
		HelicobacterPylori other = (HelicobacterPylori) obj;
		if (id != other.id)
			return false;
	...
	public String toString() {
		return "HelicobacterPylori [id ="+ id +", idExpediente=" + idExpediente 
