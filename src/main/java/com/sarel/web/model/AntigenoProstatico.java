...
@Entity
@Table(name="ANTIGENO_PROSTATICO")
public class AntigenoProstatico {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof AntigenoProstatico))
			return false;
		AntigenoProstatico other = (AntigenoProstatico) obj;
		if (id != other.id)
			return false;
	...
	public String toString() {
		return "AntigenoProstatico [id ="+ id +", idExpediente=" + idExpediente 
